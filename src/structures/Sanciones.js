...
/**
 * Matriz de sanciones fija por diseño narrativo.
 * Acceso: Sanciones[dia][numero]
 *   - dia    : 1–6
 *   - numero : 0 = sanción principal del día, 1+ = sanciones secundarias
 */
export const Sanciones = {

    // =========================================================
    //  DÍA 1 — Injuria (tutorial)
    // =========================================================
    1: [
    ...
    // =========================================================
    //  DÍA 2 — Injuria agravada (continuación tutorial)
    // =========================================================
    2: [
        new ContenidoSancion(
